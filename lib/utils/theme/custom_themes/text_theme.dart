...
class NTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall: const TextStyle().copyWith(fontSize: 12,fontWeight: FontWeight.bold,color: Colors.white),
